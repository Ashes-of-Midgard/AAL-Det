...
from ..utils import filter_scores_and_topk, images_to_levels, multi_apply, gt_instances_preprocess, make_divisible_yolo
...
class YOLOv5HeadModule(BaseModule):
    ...
    def __init__(self,
        ...
        if isinstance(in_channels, int):
            self.in_channels = [make_divisible_yolo(in_channels, widen_factor)
                                ] * self.num_levels
        else:
            self.in_channels = [
                make_divisible_yolo(i, widen_factor) for i in in_channels
            ]
...
class YOLOv8HeadModule(BaseModule):
    ...
    def __init__(self,
        ...
        for channel in self.in_channels:
            channel = make_divisible_yolo(channel, widen_factor)
